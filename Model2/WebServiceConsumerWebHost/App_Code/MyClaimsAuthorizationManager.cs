...
namespace CommercialVehicle_WSC
{
    ...
    public class MyClaimsAuthorizationManager : ClaimsAuthorizationManager
    {
        ...
        {
            // TEMP
            ClaimsUtil.LogClaimsPrincipal(pec.Principal, "CommercialVehicle_WSC.MyClaimsAuthorizationManager.CheckAccess");

            bool accessGranted = true; 
            // _policies[new ResourceAction(pec.Resource.First<Claim>().Value, pec.Action.First<Claim>().Value)](pec.Principal);
